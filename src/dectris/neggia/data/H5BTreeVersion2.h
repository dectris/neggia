...
private:
    ...
    size_t getRecordAddressWithinInternalNode(size_t record, const Node & node) const;
    size_t getRecordAddressWithinInternalNodeFromLinkHash(uint32_t linkHash, const Node & node) const;
    Node getChildNode(const Node& parentNode, size_t childNodeNumber) const;
    size_t getChildNodeAddress(const Node& parentNode, size_t childNodeNumber) const;
    size_t getNumberOfRecordsForChildNode(const Node& parentNode, size_t childNodeNumber) const;
    size_t getTotalNumberOfRecordsForChildNode(const Node& parentNode, size_t childNodeNumber) const;
